//! Live `MySQL` integration tests (REF-274 / REF-275).
//!
...
fn mysql80_smoke_connect_introspect_select() {
    smoke_connect_introspect_select(MYSQL80_DSN_VAR, "smoke80");
}

#[test]
#[ignore = "requires live DB (scripts/test-live.sh)"]
fn mysql84_smoke_connect_introspect_select() {
    smoke_connect_introspect_select(MYSQL84_DSN_VAR, "smoke84");
}
